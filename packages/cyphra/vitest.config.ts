...
export default defineConfig({
  resolve: {
    alias: {
      "@cyphra/core": path.join(monorepoRoot, "packages/core/src/index.ts"),
      ...
      "@cyphra/provider-neo4j": path.join(monorepoRoot, "packages/provider-neo4j/src/index.ts"),
      "@cyphra/runtime": path.join(monorepoRoot, "packages/runtime/src/index.ts"),
      "@cyphra/orm": path.join(monorepoRoot, "packages/orm/src/index.ts"),
